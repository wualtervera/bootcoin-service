...
public class KafkaConsumerConfig {
    ...
    //@Bean
    public ConsumerFactory<String, BootcoinTransactionDto> walletTransactionDtoConsumerFactory() {

        JsonDeserializer<BootcoinTransactionDto> deserializer = new JsonDeserializer<>(BootcoinTransactionDto.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, BootcoinTransactionDto> walletConcurrentKafkaListenerContainerFactory() {
